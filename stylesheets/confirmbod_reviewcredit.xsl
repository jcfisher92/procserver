<!--
   ...
   for a credit review email. 

   Author: Paul Davidson

   Date created: 07/26/2006
   Last update : $Id: confirmbod_reviewcredit.xsl,v 1.1 2009/02/04 16:08:00 pdavidson Exp $

   History:
      $Log: confirmbod_reviewcredit.xsl,v $
      ...
      Revision 1.3  2007/07/11 04:54:49  pdavidson
      Merged from credit shortage branch

      Revision 1.2  2006/07/27 19:30:27  pdavidso
      Reworked

      Revision 1.1  2006/07/27 17:58:54  pdavidso
      Initial commit
-->
...
<xsl:template match="oa:ApplicationArea">
   ...
   <xsl:text>This request needs to be reviewed by the credit department.</xsl:text>
   <xsl:text>
</xsl:text>
   <xsl:text>
</xsl:text>
