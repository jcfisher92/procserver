 ...
 *
 */
public class FasJobProc implements Runnable 
{
   private static long startId = 1;
   static final int whs00 = 0;
   static final int whsPortland = 1;
   static final int whsPittston = 2;

   protected FasApp m_App;          // Pointer to the process application instance.
   protected String m_CurProcStatus;
   protected String m_FasFacId;     // The fascor facility ID
   ...
   protected int m_WhsId;           // The Emery warehouse ID
    ...
    * @param name
    */
   public FasJobProc(FasApp app, String name) 
   {
      this();
            ...
            while ( m_Status != ProcessServer.stopped ) {
               try {
                  ...
                  if ( ex instanceof InterruptedException ) {
                     ...
                     logMsg.append("[FasJobProc] There was an exception during processing.  See ../log/server.log for the stacktrace\r\n");

                     logMsg.append("[FasJobProc] The exception was:\r\n");
    ...
    */
   public void setApplication(FasApp app) throws Exception 
   {
      if ( app != null ) {
         m_App = app;
         ...
         throw new Exception("[FasJobProc] parent application can't be set to null");
   }
    ...
    * @return
    */
   public void setFasFacId(String fasFacId) 
   {
      m_FasFacId = fasFacId;
   }
